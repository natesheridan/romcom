// Refactor code for class functionality 

// GLOBAL VARIABLES

//DOM ELEMENTS to CHANGE / MANIPULATE 
...
//RANDOMIZED VARIABLES
          ...
          //     var randomDescriptor2 = descriptors[getRandomIndex(descriptors)];
          //   }
//NEW RANDOM VALUES - this is needed to update all the variables above each time they are referenced
...
function generateNewRandomValues(){
  ...
  var randomCover = covers[getRandomIndex(covers)];
    if (randomDescriptor1 === randomDescriptor2){
      var randomDescriptor2 = descriptors[getRandomIndex(descriptors)];
  var randomizedArray = [randomTitle, randomDescriptor1, randomDescriptor2, randomCover]
  return randomizedArray;
  }
}
//DOM ELEMENTS to LISTEN FOR EVENTS ON
...
// DOM ELEMENTS eventListeners
  ...
  showNewCoverBtn.addEventListener('click' , function(){randomPosterBtn()});
...
class Poster {
  constructor(title = randomTitle, tagline1 = randomDescriptor1, tagline2 = randomDescriptor2, cover = randomCover){
      this.title = title;
  ...
  updatePoster(){
    ...
    descriptor1.innerText = this.tagline1;
    descriptor2.innerText = this.tagline2;
...
function randomPosterBtn(){
  generateNewRandomValues();
  title.innerText = randomizedArray[0];
  descriptor1.innerText = randomArray[1];
  descriptor2.innerText = randomArray[2];
  cover.src = randomArray[3];
}




//               CHANGING PAGES/VIEWS
...
viewHome() //this is default view make sure all buttons that are supposed to be hidden are on refresh

  //switch view to saved-view
function viewSaved(){
